...
public class Sequences {
    ...
    /**
     * The sequence <code>public.performance_id_seq</code>
     */
    public static final Sequence<Long> PERFORMANCE_ID_SEQ = new SequenceImpl<Long>("performance_id_seq", Public.PUBLIC, org.jooq.impl.SQLDataType.BIGINT.nullable(false));

    /**
     * The sequence <code>public.venue_id_seq</code>
     */
    public static final Sequence<Long> VENUE_ID_SEQ = new SequenceImpl<Long>("venue_id_seq", Public.PUBLIC, org.jooq.impl.SQLDataType.BIGINT.nullable(false));
}
